...
- **Chat-based troubleshooting:** DevOps engineers can ask Gen AI: *"Why did my Kubernetes pod crash?"* → AI analyzes logs and suggests probable causes like OOM (Out of Memory) errors.
